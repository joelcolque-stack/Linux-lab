 ...
 log "ERROR" " ’$DIR_BACKUP’ existe pero no es undirectorio."
 return 1
 fi
 ...
 # Contar archivos modificados en las ú ltimas MAX_HORAShoras
 ...
 verificar_tamanio () {
 log "INFO" "Verificando tamaño del directorio debackups ... "
